...
var app = new (vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_0___default())({
  ...
  methods: {
    pressNumber: function pressNumber(event) {
      var key = event.target.innerText;
      app.current += key;
    },
    pressEquals: function pressEquals() {
      if (app.current !== '') {
        var input = app.current;
    ...
    pressMultiply: function pressMultiply() {
      app.current += "*";
    },
    pressDivide: function pressDivide() {
      app.current += "/";
    },
    pressPlus: function pressPlus() {
      app.current += "+";
    },
    pressMinus: function pressMinus() {
      app.current += "-";
    },
